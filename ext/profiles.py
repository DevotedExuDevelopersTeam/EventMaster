...
class EventProfile(Cog):
    ...
    @commands.slash_command(
        name="profile", description="Display your or other user's event profile"
    )
    async def profile(
...
class ProfileAdministration(Cog):
    ...
    @commands.slash_command(
        name="add_points", description="Adds event points to a person"
    )
    ...
    @commands.slash_command(
        name="remove_points", description="Removes event points from a person"
    )
    async def remove_points(
        ...
        try:
            ...
            await inter.send(
                "You cannot remove more points than user currently has", ephemeral=True
            )
